...
Shiny app. Everything in it comes from the demo app that ships with the
package, which you can run yourself:
...
A calendar goes in the UI with `VanillaCalendarOutput()` and is filled in the
server with `renderVanillaCalendar()`, like any other htmlwidget.
